        ...
        <header>
                ...
                <div className="header__buttons">
                    <div className="font__control">
                        <button className="font" onClick={displayDropdown}>
                            ...
                            <svg className="arrow__icon" xmlns="http://www.w3.org/2000/svg" width="14" height="8" viewBox="0 0 14 8"><path fill="none" stroke="#A445ED" stroke-width="1.5" d="m1 1 6 6 6-6"/></svg>
                        </button>
                    ...
                    <div className="theme__controls">
                        ...
                        <svg className="moon__icon" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"><path fill="none" stroke="#838383" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M1 10.449a10.544 10.544 0 0 0 19.993 4.686C11.544 15.135 6.858 10.448 6.858 1A10.545 10.545 0 0 0 1 10.449Z"/></svg>
                    </div>
                </div>
            </div>
            ...
            <form>
                <label htmlFor="search">
                    <input type="text" name="search" id="search" value={word} onChange={handleChange} onFocus={handleFocus}/>
                </label>
                <button type="submit">
